...
function Hero() {
    return (
        <div className='container'>
            ...
            <div className='row mt-5 p-5 border-top  text-body-secondary' style={{lineHeight:"1.8",fontSize:"1.1em"}}>
                <div className='col-6 p-5'>
                    <p>
                        We kick-started operations on the 15th of August, 2010 with the goal of breaking all barriers that traders and investors face in India in terms of cost, support, and technology. We named the company Zerodha, a combination of Zero and "Rodha", the Sanskrit word for barrier.</p> <p>
