    ...
    return (
        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                ...
                <div className='col'>
                    <p>Company</p>
                    <a href="" className='text-body-secondary' style={{textDecoration:"none",color:"black"}}>About</a><br></br>
                ...
                <div className='col'>
                    <p>Support</p>
                    <a href="" className='text-body-secondary' style={{textDecoration:"none",color:"black"}}>Contact us</a><br></br>
                ...
                <div className='col'>
                    <p>Account</p>
                    <a href="" className='text-body-secondary' style={{textDecoration:"none",color:"black"}}>Open an account</a><br></br>
